// Class_1.cpp : This file contains the 'main' function. Program execution begins
// and ends there. 
...
cout << endl << "Result of multiplication between " << a << " and " << b << "
is " << results_in_struct.multiplication;
cout << endl << "Result of multiplication between " << a << " and " << b << "
is " << multip;
return 0;
}
